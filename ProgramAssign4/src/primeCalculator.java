 ...
 *Prime Generator. Calculates the number of primes between 2 and a user-inputted value, inclusive. Prints the number of checks it performed and the total number of primes generated.
 */
public class primeCalculator {
	public static void main(String[] args){
		...
		for(int i = 2; i <= primeLimit; i++){ //while less than the number to calculate to
			isPrime = true;
			for(int j = 2; (j <= (i/2)) && isPrime; j++){ //while j is less than half of i and i is still prime (yet) 
